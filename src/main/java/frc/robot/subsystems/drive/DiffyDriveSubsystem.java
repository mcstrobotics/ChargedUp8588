...
public class DiffyDriveSubsystem implements DriveSubsystemInterface {
    private DiffyDriveChassis chassis;
    private DiffyDriveInputs inputs;
    ...
    public DiffyDriveSubsystem(DiffyDriveChassis chassis, DiffyDriveInputs inputs) {
